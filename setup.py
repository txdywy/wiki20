...
execfile(os.path.join('wiki20', 'release.py'))

packages = find_packages()
package_data = find_package_data(where='wiki20',
    package='wiki20')
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'start-wiki20 = wiki20.command:start',
            # See the wiki20.command.bootstrap function for details
