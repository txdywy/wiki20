...
# symbols which are imported by "from wiki20.command import *"
...
from wiki20.release import version
    ...
    if args:
        ...
        try:
            configfile = pkg_resources.resource_filename(
              pkg_resources.Requirement.parse('wiki20'),
                'config/default.cfg')
        except pkg_resources.DistributionNotFound:
...
def bootstrap():
    ...
    By default this runs the function 'wiki20.model.bootstrap_model', which
    ...
    easy_install which will run this function:
        ...
        'bootstrap-wiki20 = wiki20.command:bootstrap',
    ...
    optparser = optparse.OptionParser(usage="%prog [options] [config-file]",
        ...
        "config-file.", version="wiki20 %s" % version)
    ...
    _read_config(args)
    from wiki20.model import bootstrap_model
